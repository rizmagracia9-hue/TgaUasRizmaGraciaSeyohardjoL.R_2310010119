 ...
 * @author ThinkPad
 */
public class Frameiuran extends javax.swing.JFrame {

    /**
     * Creates new form Frameiuran
     */
    public Frameiuran() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("id iuran");

        jLabel2.setText("id golongan");

        jLabel3.setText("jenis iuran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frameiuran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frameiuran().setVisible(true);
            }
        });
    }
